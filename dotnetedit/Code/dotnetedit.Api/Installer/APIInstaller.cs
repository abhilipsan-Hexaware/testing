...
using ElmahCore.Mvc;
using ElmahCore;
using dotnetedit.Api.Filters;
using dotnetedit.BusinessServices.Installer;

namespace dotnetedit.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnetedit API", Version = version + "-" + branch});
            });
